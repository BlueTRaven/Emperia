...
namespace Emperia.Weapons.Color1   //where is located
{
    public class Dusk : ModItem
    {
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Striking an enemy will increase melee damage, life regeneration and armor penetration for a short time");
		}
        ...
        public override void AddRecipes()  //How to craft this sword
        {
			...
			recipe.AddIngredient(null, "IndigoLaitō", 1); 
		...
		{
			player.AddBuff(mod.BuffType("DuskBuff"), Main.rand.Next(500, 1000));
		}
