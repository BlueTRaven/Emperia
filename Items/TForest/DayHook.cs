...
{
	class DayHookItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Enchanted Grip");
		}
	...
	class DayHookProjectile : ModProjectile
	{
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			while (distance > 30f && !float.IsNaN(distance))
			{
				...
				//Draw chain
				spriteBatch.Draw(mod.GetTexture("Items/TForest/DayHookChain"), new Vector2(center.X - Main.screenPosition.X, center.Y - Main.screenPosition.Y),
