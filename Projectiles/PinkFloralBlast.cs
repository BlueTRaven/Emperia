...
namespace Emperia.Projectiles
{
    ...
    public class PinkFloralBlast : ModProjectile
    {
		...
		public override void Kill(int timeLeft)
        {
			...
			for (int index = 0; index < num; ++index)
			{
				...
				Projectile.NewProjectile(projectile.oldPosition.X + (float) (projectile.width / 2), projectile.oldPosition.Y + (float) (projectile.height / 2), vector2.X, vector2.Y, mod.ProjectileType("PinkFloralBlast2"), (int) ((double) projectile.damage * 0.8), projectile.knockBack * 0.8f, projectile.owner, 0.0f, 0.0f);
